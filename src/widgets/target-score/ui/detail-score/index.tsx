  ...
  return (
    <div>
      ...
      <div className="py-2 px-4 flex items-center space-x-2 border-neutral-200 border-b">
        ...
        <h3 className="font-bold font-nunito text-base">
          My IELTS score target
        </h3>
      </div>
      <div className="p-3">
        <div className="flex items-stretch -m-1 flex-wrap">
          <div className="w-full md:w-1/4 p-1">
            <button
              type="button"
              className="pt-2.5 px-2.5 pb-1 rounded-md bg-primary-50 space-y-1 w-full cursor-pointer"
            ...
            >
              ...
              <div className="flex justify-between items-end">
                <p className="text-2xl md:text-5xl font-nunito font-bold text-primary-400">
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="mb-1.5 text-primary flex-shrink-0"
                >
                  <path
          ...
          <div className="w-full md:w-3/4 p-1">
            <div className="flex -mx-1 h-full items-stretch">
              {["Listening", "Reading", "speaking", "Writing"].map(
                (item, index) => (
                  <div className="px-1 w-1/4" key={index}>
                    <button
                      onClick={() => setIsSetTargetScoreDialogOpen(true)}
                      className="rounded-md border border-neutral-200 h-full pt-2.5 px-2.5 pb-1 flex flex-col justify-between w-full cursor-pointer"
                    >
                      <p className="text-xs text-left">{_.capitalize(item)}</p>
                      <div className="flex justify-between items-end">
