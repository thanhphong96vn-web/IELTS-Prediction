...
export const PagePrivacyPolicy = ({ privacyPolicyConfig }: PagePrivacyPolicyProps) => {
  const { banner, heroImage, content } = privacyPolicyConfig;
...
PagePrivacyPolicy.Layout = BaseLayout;
