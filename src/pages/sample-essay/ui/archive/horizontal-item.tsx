...
export const HorizontalItem = ({
  ...
  return (
    <article className="bg-white">
      ...
      >
        {/* Thumbnail - Left */}
        <div className="w-32 h-24 shrink-0 rounded overflow-hidden relative bg-gray-100">
        ...
        <div className="flex-1 min-w-0 space-y-1 text-left">
          ...
          {/* Title */}
          <h4 className="text-base md:text-lg font-bold text-gray-900 leading-tight text-left">
            {post.title}
          </h4>
